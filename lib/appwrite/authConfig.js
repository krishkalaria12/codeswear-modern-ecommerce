...
export class Authservice {
    ...
    async createPhoneSession({phone, userId}) {
        try {
            const phoneAccount = await this.account.createPhoneSession(userId, phone);
            return phoneAccount;
        } catch (error) {
            throw error;
        }
    ...
    async updatePhoneSession(secret, {userId}) {
        try {
            const phoneAccount = await this.account.updatePhoneSession(userId, secret);
            return phoneAccount;
        } catch (error) {
            throw error;
        }

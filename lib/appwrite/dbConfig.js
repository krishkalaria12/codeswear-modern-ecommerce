...
export class Service{
    ...
    async createOrder({firstname,lastname,email,phoneno,city,country,flatno,postalCode ,state, orderid, userid}) {
        try {
            return await this.databases.createDocument(
                conf.appwriteDatabaseId,
                conf.appwriteOrdersCollectionId,
                ID.unique(),
                {firstname,lastname,email,phoneno,city,country,flatno,state,orderid,postalCode, userid}
            )
        } catch (error) {
